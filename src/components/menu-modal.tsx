...
const fullMenuBenselam = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: "Makkai Bhel",
        description:
          "Sweet corn and desi 'Kurkure', tossed with tangy chutneys.",
        price: "$9.99",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Pan-fried chicken dumplings tossed in a fiery schezwan sauce.",
        price: "$13.99",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: "Malai Broccoli",
        description:
          "Creamy broccoli florets, lightly spiced, charred in the tandoor.",
        price: "$12.99",
      },
    ],
  },
  ...
  {
    category: "Beverages",
    items: [{ name: "Tea / Coffee", description: "", price: "$2.99" }],
  },
  {
    category: "Drinks",
    items: [
      ...
      },
      {
        name: "Jigarthanda",
        description:
          "South Indian cooling drink. Milk, almond gum, sarsaparilla, ice cream.",
        price: "$6.99",
      },
      {
        name: "Mango Lassi",
      ...
      },
      {
        ...
        description:
          "Cool, frosty lemonade blended with fresh mint for a crisp, refreshing twist.",
        price: "$4.99",
      },
      {
