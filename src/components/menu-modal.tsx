...
const fullMenuBenselam = [
  {
    ...
    items: [
      ...
      { name: "Cream of Tomato", description: "Cream of tomato is a flavorful, tangy South Indian tomato broth, spiced with aromatic herbs and seasonings.", price: "$5.99" },
  ...
  },
  {
    category: "Bites",
    items: [
      { name: "Green Salad", description: "Our classic Indian green salad, featuring a medley of farm-fresh vegetables.", price: "$4.99" },
      { name: "Papad - Roasted / Fried", description: "Crisp lentil wafers. Your choice: roasted or fried.", price: "$2.99" },
      { name: "Masala Papad", description: "Crisp papad topped with spicy onion-tomato mix and chaat masala.", price: "$3.99" },
      { name: "Masala Peanut", description: "Roasted peanuts tossed with onion, tomato, and spices.", price: "$5.99" },
...
items: [
  ...
  },
  {
    ...
    description: "Crispy, spiced potato patties served with tangy chutneys, creamy yogurt, and savory spices.", 
    price: "$11.99" 
  },
  { 
    name: "Papdi Chaat", 
  ...
  { 
    name: "Samosa", 
    description: "Crispy, golden pastry filled with spiced potato goodness.", 
    price: "$5.99" 
  },
  { 
    name: "Pakora Platter", 
  ...
  },
{
  ...
  items: [
    ...
    { 
      name: "Tandoori Aloo", 
      description: "Smoky, flavorful and tender potatoes, tandoor-kissed.", 
      price: "$12.99" 
    },
    { 
      name: "Malai Broccoli", 
...
items: [
  ...
  { 
    name: "Dahi Puri", 
    description: "Mumbai-style dahi puri. Crisp puris stuffed with potatoes, yogurt, and chutneys.", 
    price: "$10.99" 
  }
]
...
},
{
  ...
  items: [
    ...
    { 
      name: "Paan Kulfi", 
      description: "Homemade Indian ice cream, inspired by fresh Pann (betel leaf).", 
      price: "$8.99" 
    }
  ]
}
